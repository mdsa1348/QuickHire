...
export default function Home() {
  ...
  const fetchJobs = async () => {
    try {
      ...
      // If we have data from backend, use it. Otherwise, use mock data to satisfy visual requirement
  ...
  const categories = [
    { 
      ...
      count: 235, 
      icon: (
        <svg className="w-8 h-8 text-[#4640DE]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  const featuredJobsData = [
    { title: 'Email Marketing', company: 'Revolut', location: 'Madrid, Spain', description: 'Revolut is looking for Email Marketing to help team ma ...', categories: ['Marketing', 'Design'], logo: 'R' },
    { title: 'Brand Designer', company: 'Dropbox', location: 'San Fransisco, US', description: 'Dropbox is looking for Brand Designer to help the team t ...', categories: ['Design', 'Business'], logo: 'D' },
    { title: 'Email Marketing', company: 'Pitch', location: 'Berlin, Germany', description: 'Pitch is looking for Customer Manager to join marketing t ...', categories: ['Marketing'], logo: 'P' },
    { title: 'Visual Designer', company: 'Blinklist', location: 'Granada, Spain', description: 'Blinklist is looking for Visual Designer to help team desi ...', categories: ['Design'], logo: 'B' },
    { title: 'Product Designer', company: 'ClassPass', location: 'Manchester, UK', description: 'ClassPass is looking for Product Designer to help us...', categories: ['Marketing', 'Design'], logo: 'C' },
    { title: 'Lead Designer', company: 'Canva', location: 'Ontario, Canada', description: 'Canva is looking for Lead Engineer to help develop n ...', categories: ['Design', 'Business'], logo: 'Ca' },
    { title: 'Brand Strategist', company: 'GoDaddy', location: 'Marseille, France', description: 'GoDaddy is looking for Brand Strategist to join the team...', categories: ['Marketing'], logo: 'G' },
    { title: 'Data Analyst', company: 'Twitter', location: 'San Diego, US', description: 'Twitter is looking for Data Analyst to help team desi ...', categories: ['Technology'], logo: 'T' },
  ];
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-[#F8F8FD] min-h-screen relative flex flex-col justify-center px-6 md:px-32 pt-24 pb-16 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-full lg:w-[45%] h-32 lg:h-[25%] bg-white z-20" 
        ...
        <div className="max-w-[1440px] mx-auto w-full flex flex-col lg:flex-row items-center relative z-10">
          <div className="flex-1 lg:max-w-[65%] pt-10 lg:pt-0">
            ...
            <p className="mt-10 text-[#515B6F] font-bold text-xl">
              Popular : <span className="text-[#25324B]">UI Designer, UX Researcher, Android, Admin</span>
            </p>
          </div>
      ...
      <section className="py-24 px-6 md:px-32 bg-white relative z-30 border-t border-[#F1F1F1]">
        <div className="max-w-[1440px] mx-auto">
          <div className="flex justify-between items-end mb-20">
            <h2 className="text-5xl md:text-6xl font-black text-[#25324B]">
              Explore by <span className="text-[#26A4FF]">category</span>
            </h2>
            <Link href="#" className="text-primary font-black flex items-center gap-3 group text-xl border-b-2 border-transparent hover:border-primary pb-1 transition-all">
              Show all jobs
      ...
      <section className="px-6 md:px-32 bg-white relative z-30 py-16">
        <div className="max-w-[1440px] mx-auto bg-[#4640DE] relative flex flex-col md:flex-row items-center min-h-[480px] overflow-hidden">
          {/* Extremely Small Top-Left white cut */}
          <div 
            className="absolute top-0 left-0 w-34 h-14 bg-white z-20 pointer-events-none"
            style={{ clipPath: 'polygon(0 0, 0 100%, 100% 0)' }}
          ></div>

          {/* Extremely Small Bottom-Right white cut (behind image) */}
          <div 
            className="absolute bottom-0 translate-y-1 right-0 w-34 h-20 bg-white z-0 pointer-events-none"
            style={{ clipPath: 'polygon(100% 0, 100% 100%, 0 100%)' }}
          ></div>
      ...
      <section className="py-24 px-6 md:px-32 bg-white relative z-30">
        <div className="max-w-[1440px] mx-auto">
          <div className="flex justify-between items-end mb-16">
            ...
            <Link href="#" className="text-primary font-black flex items-center gap-3 group text-xl hover:opacity-80 transition-all">
              Show all jobs
              <svg className="w-6 h-6 transition-transform group-hover:translate-x-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
            </Link>
          </div>
      ...
      <section className="py-32 px-6 md:px-32 bg-[#F8F8FD] relative z-30 overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto relative z-10">
          <div className="flex justify-between items-end mb-20">
            ...
            <Link href="#" className="text-[#4640DE] font-black flex items-center gap-3 group text-xl transition-all">
              Show all jobs
              <svg className="w-6 h-6 transition-transform group-hover:translate-x-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
            </Link>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto">
          <div className="flex flex-col md:flex-row flex-wrap justify-between mb-20 border-b border-white/10 pb-20 gap-y-12">
            <div className="w-full md:w-[32%]">
              ...
              <p className="text-[#D6DDEB] text-lg leading-relaxed mb-10 max-w-xs font-medium">
